        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-8">
            <button
              ...
              className={`font-medium transition-colors hover:text-accent ${isScrolled ? 'text-foreground' : 'text-primary-foreground'}`}
            >
              Services
            </button>
            <button
              onClick={() => scrollToSection("ocean")}
              className={`font-medium transition-colors hover:text-accent ${isScrolled ? 'text-foreground' : 'text-primary-foreground'}`}
            >
              Ocean Freight
            </button>
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden mt-4 py-4 border-t border-border/20 animate-fade-in">
            <div className="flex flex-col gap-4">
              <button
                onClick={() => scrollToSection("services")}
                className="text-left font-medium text-foreground hover:text-accent py-2"
              >
                Services
              </button>
              <button
