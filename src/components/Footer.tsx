      ...
      <div className="container-wide section-padding pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <a href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-display text-xl font-bold">ExpressWays</span>
            </a>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#ocean" className="text-primary-foreground/70 hover:text-accent transition-colors">
                  Ocean Freight
                </a>
              </li>
              <li>
                <a href="#land" className="text-primary-foreground/70 hover:text-accent transition-colors">
                  Land Transport
                </a>
              </li>
              <li>
                <a href="#air" className="text-primary-foreground/70 hover:text-accent transition-colors">
                  Air Freight
                </a>
              </li>
              <li>
                <a href="#warehouse" className="text-primary-foreground/70 hover:text-accent transition-colors">
                  Warehousing
                </a>
              </li>
              <li>
                <a href="#delivery" className="text-primary-foreground/70 hover:text-accent transition-colors">
                  Last Mile Delivery
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#tracking" className="text-primary-foreground/70 hover:text-accent transition-colors">
                  Track Shipment
                </a>
              </li>
              <li>
        ...
        <div className="pt-8 border-t border-primary-foreground/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-primary-foreground/50 text-sm">
            © {new Date().getFullYear()} ExpressWays Logistics. All rights reserved.
          </p>
